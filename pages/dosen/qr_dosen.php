...
// Ruang default dosen (sesuai DB: Ruang Dosen)
$roomId = 2;
...
<aside id="sidebar"
    ...
    <ul class="p-5 space-y-5 text-blue-900 font-medium">
        <li>
            <a href="home_dosen.php" class="block hover:text-blue-500">
                <i class="fa-solid fa-house mr-2"></i> Home
            </a>
        </li>
        <li>
            <a href="apps_dosen.php" class="block font-bold text-blue-600">
                <i class="fa-solid fa-qrcode mr-2"></i> Apps
            </a>
        </li>
        <li>
            <a href="../../public/logout.php" class="block hover:text-red-500">
...
<nav class="w-full bg-white shadow-md py-5 px-10 flex items-center justify-between md:justify-center gap-16 z-30">
    ...
    <h1 class="text-2xl font-bold text-blue-900 hidden md:block">
        QR Code Akses Dosen
    </h1>
</nav>
...
<section class="w-full pt-8 pb-6 mb-8 border-b-2 border-gray-200">
    <div class="max-w-4xl mx-auto text-center px-6">
        ...
        <p class="text-gray-600">Tunjukkan QR ini kepada petugas keamanan</p>
    </div>
</section>
...
<section class="px-6 max-w-lg mx-auto pb-16">
    <div class="bg-white rounded-2xl p-6 shadow-xl border-t-8 border-blue-950">
        ...
        <p class="text-xs text-gray-500 text-center mt-4">
            QR bersifat sementara dan diverifikasi otomatis oleh sistem
        </p>
