...
<body class="bg-gray-50">
    ...
    <body class="bg-gray-50">
        ...
        <nav
            class="w-full bg-white shadow-md py-5 px-10 flex items-center justify-between md:justify-center gap-16 z-30">
            ...
            <ul class="hidden md:flex space-x-10 text-blue-900 font-medium items-center">
                <li><a href="home_dosen.php" class="hover:text-blue-600 transition duration-150">Home</a>
                </li>
