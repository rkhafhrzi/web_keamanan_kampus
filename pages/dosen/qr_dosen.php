...
if (!isset($_SESSION['user']) || !is_array($_SESSION['user']) || ($_SESSION['user']['role'] !== 'dosen')) {
...
<body class="bg-gray-50">
    ...
    <aside id="sidebar"
        ...
        <ul class="p-5 space-y-5 text-blue-900 font-medium">
            <li><a href="home_dosen.php" class="block hover:text-blue-500"><i class="fa-solid fa-house mr-2"></i>
                    Home</a></li>
            <li><a href="apps_dosen.php" class="block text-blue-900 font-bold border-l-4 border-blue-600 pl-1"><i
                        class="fa-solid fa-table-cells mr-2"></i> Apps</a></li>
            <li><a href="../../actions/logout.php" class="block hover:text-red-500"><i
    ...
    <nav class="w-full bg-white shadow-md py-5 px-10 flex items-center justify-between md:justify-center gap-16 z-30">
        ...
        <h1 class="text-2xl font-bold text-blue-900 hidden md:block">QR Code Akses Dosen</h1>
        <ul class="hidden md:flex space-x-10 text-blue-900 font-medium items-center">
            ...
            <li><a href="apps_dosen.php" class="text-blue-600 font-bold border-b-2 border-blue-600 pb-1 transition duration-150">Apps</a>
            </li>
            <li>
    ...
    <main class="min-h-screen bg-gray-50">
        ...
        <section class="w-full bg-gray-50 pt-8 pb-6 mb-8 border-b-2 border-gray-200">
            <div class="max-w-4xl mx-auto text-center px-6">
                ...
                <p class="text-gray-600 text-base">Gunakan untuk presensi, akses masuk, dan verifikasi identitas.</p>
            </div>
        </section>
        ...
        <section class="mt-4 px-6 max-w-lg mx-auto pb-16">
            ...
            <div class="bg-white rounded-2xl p-6 shadow-xl border-t-8 border-blue-950
                ...
                <p class="text-gray-600 text-sm mb-4 text-center">Tunjukkan QR Code ini kepada petugas keamanan.</p>
                ...
                <div class="text-center mb-4 border-b pb-3 border-gray-200">
                    ...
                    <p class="text-sm text-gray-600">
                        <?= htmlspecialchars($role_display) ?>: <span class="font-semibold text-blue-800"><?= htmlspecialchars($kode) ?></span>
                    </p>
                </div>
